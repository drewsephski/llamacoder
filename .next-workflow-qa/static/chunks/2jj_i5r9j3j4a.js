(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,459191,e=>{"use strict";var a=e.i(73180),r=e.i(242879),t=e.i(484745),o=e.i(57255),s=e.i(519879),n=e.i(65666),i=e.i(383379),l=e.i(723925),d=e.i(903645);let c=(0,d.default)("cloud-sun",[["path",{d:"M12 2v2",key:"tus03m"}],["path",{d:"m4.93 4.93 1.41 1.41",key:"149t6j"}],["path",{d:"M20 12h2",key:"1q8mjw"}],["path",{d:"m19.07 4.93-1.41 1.41",key:"1shlcs"}],["path",{d:"M15.947 12.65a4 4 0 0 0-5.925-4.128",key:"dpwdj0"}],["path",{d:"M13 22H7a5 5 0 1 1 4.9-6H13a3 3 0 0 1 0 6Z",key:"s09mg5"}]]);var m=e.i(208986),p=e.i(681181),u=e.i(987889);let h=(0,d.default)("files",[["path",{d:"M15 2h-4a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V8",key:"14sh0y"}],["path",{d:"M16.706 2.706A2.4 2.4 0 0 0 15 2v5a1 1 0 0 0 1 1h5a2.4 2.4 0 0 0-.706-1.706z",key:"1970lx"}],["path",{d:"M5 7a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2h8a2 2 0 0 0 1.732-1",key:"l4dndm"}]]);var v=e.i(670471);let g=(0,d.default)("landmark",[["path",{d:"M10 18v-7",key:"wt116b"}],["path",{d:"M11.12 2.198a2 2 0 0 1 1.76.006l7.866 3.847c.476.233.31.949-.22.949H3.474c-.53 0-.695-.716-.22-.949z",key:"1m329m"}],["path",{d:"M14 18v-7",key:"vav6t3"}],["path",{d:"M18 18v-7",key:"aexdmj"}],["path",{d:"M3 22h18",key:"8prr45"}],["path",{d:"M6 18v-7",key:"1ivflk"}]]);var f=e.i(674224),b=e.i(38447);let x=(0,d.default)("monitor-play",[["path",{d:"M15.033 9.44a.647.647 0 0 1 0 1.12l-4.065 2.352a.645.645 0 0 1-.968-.56V7.648a.645.645 0 0 1 .967-.56z",key:"vbtd3f"}],["path",{d:"M12 17v4",key:"1riwvh"}],["path",{d:"M8 21h8",key:"1ev6f3"}],["rect",{x:"2",y:"3",width:"20",height:"14",rx:"2",key:"x3v2xh"}]]),y=(0,d.default)("radio",[["path",{d:"M16.247 7.761a6 6 0 0 1 0 8.478",key:"1fwjs5"}],["path",{d:"M19.075 4.933a10 10 0 0 1 0 14.134",key:"ehdyv1"}],["path",{d:"M4.925 19.067a10 10 0 0 1 0-14.134",key:"1q22gi"}],["path",{d:"M7.753 16.239a6 6 0 0 1 0-8.478",key:"r2q7qm"}],["circle",{cx:"12",cy:"12",r:"2",key:"1c9p78"}]]);var k=e.i(598701),w=e.i(167881),N=e.i(99558);let j=["Create a responsive command-center layout with a delivery map, working command menu, and contextual live-data rail.","Make Kanban work interactive with drag and drop, keyboard-friendly move controls, filtering, and quick task creation.","Add a drift-resistant focus timer tied to the team’s current priority.","Fetch browser-safe weather from Open-Meteo and central-bank reference rates from Frankfurter v2 in parallel.","Provide honest loading, refresh, attribution, fallback, focus, and responsive states so the exported app remains usable."],S=[{path:"App.tsx",language:"tsx",fullMatch:"",code:`import { useEffect, useMemo, useRef, useState } from "react";
...
}`}];var C=e.i(613614);let R=(0,r.default)(()=>e.A(217119),{loadableGenerated:{modules:[344847]},ssr:!1}),z=[{id:"Prompt",description:"Original request",icon:v.FileText},{id:"Plan",description:"Approved decisions",icon:f.ListChecks},{id:"Preview",description:"Interactive app",icon:x},{id:"Files",description:"Portable source",icon:h},{id:"Quality",description:"Verification report",icon:k.ShieldCheck}];function A({label:e,value:r}){return(0,a.jsxs)("div",{className:"flex min-h-20 items-center justify-between gap-5 border-b border-border/70 py-4",children:[(0,a.jsx)("p",{className:"text-sm text-muted-foreground",children:e}),(0,a.jsx)("p",{className:"text-2xl font-semibold tabular-nums",children:r})]})}function M({icon:e,label:r,value:t}){return(0,a.jsxs)("div",{className:"min-w-0 border-b border-border/70 px-3 py-4 even:border-l [&:nth-child(n+3)]:border-b-0",children:[(0,a.jsx)(e,{className:"size-4 text-primary"}),(0,a.jsx)("p",{className:"mt-3 text-xs text-muted-foreground",children:r}),(0,a.jsx)("p",{className:"mt-1 whitespace-nowrap text-sm font-medium text-foreground",children:t})]})}e.s(["ExampleWorkspace",0,function(){let[e,r]=(0,s.useState)("Preview"),[d,h]=(0,s.useState)("App.tsx"),x=(0,s.useMemo)(()=>(0,C.buildExportBundle)(S),[]),T=(0,s.useMemo)(()=>(function(e){let a=[];for(let r of e){let e=r.split("/"),t=a,o="";e.forEach((a,r)=>{o=o?`${o}/${a}`:a;let s=r===e.length-1,n=t.find(e=>e.id===o);n||(n={id:o,name:a,type:s?"file":"folder",children:s?void 0:[]},t.push(n)),s||(t=n.children??[])})}return a})(S.map(e=>e.path)),[]),_=S.find(e=>e.path===d)??S[0],E=x.qualityReport.diagnostics.length+x.qualityReport.accessibilityWarnings.length,P=x.qualityReport.apiIntegration.policyWarnings.length,I=async()=>{let e=new n.default;for(let a of x.files)e.file(a.path,a.content);let a=await e.generateAsync({type:"blob"}),r=URL.createObjectURL(a),t=document.createElement("a");t.href=r,t.download=(0,C.getExportFilename)("Waypoint"),t.click(),URL.revokeObjectURL(r)};return(0,a.jsxs)("main",{className:"min-h-screen overflow-x-clip bg-background text-foreground",children:[(0,a.jsx)("header",{className:"sticky top-0 z-40 border-b border-border/70 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/85",children:(0,a.jsxs)("div",{className:"mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6",children:[(0,a.jsxs)(o.default,{href:"/",className:"inline-flex min-h-11 items-center gap-2.5 whitespace-nowrap text-sm font-medium tracking-tight focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2",children:[(0,a.jsx)(t.default,{src:"/squidagent-logo.svg",alt:"Squid Agent",width:28,height:28,className:"size-7",priority:!0}),(0,a.jsx)("span",{className:"hidden sm:inline",children:"Squid Agent"}),(0,a.jsx)("span",{className:"hidden text-muted-foreground sm:inline",children:"/ public example"})]}),(0,a.jsxs)("div",{className:"flex items-center gap-2",children:[(0,a.jsxs)(w.Button,{variant:"outline",onClick:I,"aria-label":"Download source",className:"min-h-11 min-w-11 whitespace-nowrap px-0 sm:px-4",children:[(0,a.jsx)(p.Download,{className:"size-4"}),(0,a.jsx)("span",{className:"hidden sm:inline",children:"Download source"})]}),(0,a.jsx)(w.Button,{asChild:!0,className:"min-h-11 whitespace-nowrap",children:(0,a.jsxs)(o.default,{href:"/?starter=kanban-board",children:[(0,a.jsx)("span",{className:"hidden sm:inline",children:"Remix in Squid"}),(0,a.jsx)("span",{className:"sm:hidden",children:"Remix"}),(0,a.jsx)(i.ArrowRight,{className:"size-4"})]})})]})]})}),(0,a.jsxs)("section",{className:"mx-auto grid max-w-7xl gap-10 px-4 pb-10 pt-12 sm:px-6 sm:pb-12 sm:pt-16 lg:grid-cols-[minmax(0,1fr)_23rem] lg:items-end",children:[(0,a.jsxs)("div",{className:"min-w-0",children:[(0,a.jsxs)("p",{className:"inline-flex items-center gap-2 font-mono text-xs font-medium text-primary",children:[(0,a.jsx)("span",{className:"size-2 rounded-full bg-emerald-500","aria-hidden":"true"}),"PUBLIC BUILD · NO ACCOUNT REQUIRED"]}),(0,a.jsx)("h1",{className:"mt-5 max-w-3xl text-4xl font-semibold leading-[0.96] tracking-[-0.055em] [overflow-wrap:anywhere] sm:text-5xl lg:text-7xl",children:"A generated app you can interrogate."}),(0,a.jsx)("p",{className:"mt-5 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg sm:leading-8",children:"Use the board. Start the timer. Refresh two public APIs. Then inspect the original prompt, approved plan, portable source, and recorded quality checks behind Waypoint."})]}),(0,a.jsxs)("div",{className:"grid grid-cols-2 border-y border-border/70",children:[(0,a.jsx)(M,{icon:u.Eye,label:"App runtime",value:"Interactive"}),(0,a.jsx)(M,{icon:m.Code2,label:"Source export",value:"Portable"}),(0,a.jsx)(M,{icon:y,label:"API contracts",value:"2 public"}),(0,a.jsx)(M,{icon:l.Check,label:"Recorded quality",value:`${x.files.length} files`})]})]}),(0,a.jsx)("div",{className:"mx-auto max-w-7xl px-4 sm:px-6",children:(0,a.jsxs)("div",{className:"grid border-y border-border/70 text-sm sm:grid-cols-[auto_minmax(0,1fr)_auto_minmax(0,1fr)] sm:items-center",children:[(0,a.jsxs)("div",{className:"flex min-h-14 items-center gap-3 border-b border-border/70 py-3 sm:border-b-0 sm:border-r sm:px-4",children:[(0,a.jsx)(c,{className:"size-4 shrink-0 text-primary"}),(0,a.jsx)("span",{className:"whitespace-nowrap font-medium",children:"Open-Meteo"})]}),(0,a.jsx)("p",{className:"border-b border-border/70 py-3 text-muted-foreground sm:border-b-0 sm:px-4",children:"Live Chicago forecast with explicit sample fallback."}),(0,a.jsxs)("div",{className:"flex min-h-14 items-center gap-3 border-b border-border/70 py-3 sm:border-b-0 sm:border-l sm:border-r sm:px-4",children:[(0,a.jsx)(g,{className:"size-4 shrink-0 text-primary"}),(0,a.jsx)("span",{className:"whitespace-nowrap font-medium",children:"Frankfurter v2"})]}),(0,a.jsx)("p",{className:"py-3 text-muted-foreground sm:px-4",children:"Reference USD rates with timeout and retry handling."})]})}),(0,a.jsxs)("div",{className:"mx-auto max-w-7xl px-4 pb-16 pt-10 sm:px-6 sm:pb-24 sm:pt-14",children:[(0,a.jsxs)("div",{className:"grid gap-10 lg:grid-cols-[14rem_minmax(0,1fr)]",children:[(0,a.jsxs)("aside",{className:"min-w-0 lg:sticky lg:top-6 lg:self-start",children:[(0,a.jsx)("p",{className:"mb-3 text-sm font-medium text-foreground",children:"Inspect the build"}),(0,a.jsx)("nav",{"aria-label":"Example workspace sections",className:"grid grid-cols-2 border-t border-border/70 sm:grid-cols-5 lg:flex lg:flex-col",children:z.map(t=>{let o=t.icon,s=e===t.id;return(0,a.jsxs)("button",{type:"button","aria-pressed":s,onClick:()=>r(t.id),className:`group flex min-h-14 min-w-0 items-center gap-3 border-b border-border/70 px-2 text-left transition-[background-color,border-color,color] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary lg:min-h-16 lg:border-l-2 lg:px-3 ${s?"border-l-primary bg-primary/[0.05] text-foreground":"border-l-transparent text-muted-foreground hover:bg-muted/50 hover:text-foreground"}`,children:[(0,a.jsx)(o,{className:`size-4 shrink-0 ${s?"text-primary":""}`}),(0,a.jsxs)("span",{className:"min-w-0",children:[(0,a.jsx)("span",{className:"block whitespace-nowrap text-sm font-medium",children:t.id}),(0,a.jsx)("span",{className:"mt-0.5 hidden text-xs text-muted-foreground lg:block",children:t.description})]})]},t.id)})}),(0,a.jsxs)(o.default,{href:"/?starter=kanban-board",className:"mt-5 hidden min-h-11 items-center gap-2 whitespace-nowrap text-sm font-medium text-primary underline decoration-primary/30 underline-offset-4 transition-colors hover:decoration-primary lg:inline-flex",children:["Build from this example",(0,a.jsx)(i.ArrowRight,{className:"size-4"})]})]}),(0,a.jsxs)("section",{"aria-label":`${e} view`,className:"min-h-[640px] min-w-0 overflow-hidden border-y border-border/70 bg-card shadow-[0_1px_2px_hsl(var(--foreground)/0.04)]",children:["Prompt"===e&&(0,a.jsxs)("div",{className:"mx-auto max-w-4xl px-5 py-10 sm:px-10 sm:py-14 lg:px-14 lg:py-16",children:[(0,a.jsxs)("div",{className:"flex items-center gap-3 text-primary",children:[(0,a.jsx)("span",{className:"grid size-10 place-items-center rounded-lg bg-primary/10",children:(0,a.jsx)(v.FileText,{className:"size-5"})}),(0,a.jsx)("p",{className:"text-sm font-medium",children:"Original request"})]}),(0,a.jsx)("h2",{className:"mt-8 max-w-2xl text-3xl font-semibold leading-tight tracking-[-0.035em] sm:text-4xl",children:"The brief behind Waypoint"}),(0,a.jsx)("blockquote",{className:"mt-8 border-l-2 border-primary pl-5 text-xl leading-8 text-foreground/90 sm:pl-7 sm:text-2xl sm:leading-9",children:"Build a premium global delivery workspace with an interactive Kanban board, an active-task focus timer, live Chicago weather, and reference currency conversion powered by public APIs."}),(0,a.jsx)("p",{className:"mt-8 max-w-2xl text-sm leading-6 text-muted-foreground",children:"Squid turned this request into an approved plan before generating the project. Open the Plan view to inspect those decisions."})]}),"Plan"===e&&(0,a.jsxs)("div",{className:"mx-auto max-w-4xl px-5 py-10 sm:px-10 sm:py-14 lg:px-14 lg:py-16",children:[(0,a.jsxs)("div",{className:"flex items-center gap-3 text-primary",children:[(0,a.jsx)("span",{className:"grid size-10 place-items-center rounded-lg bg-primary/10",children:(0,a.jsx)(f.ListChecks,{className:"size-5"})}),(0,a.jsx)("p",{className:"text-sm font-medium",children:"Approved before generation"})]}),(0,a.jsx)("h2",{className:"mt-8 text-3xl font-semibold tracking-[-0.035em] sm:text-4xl",children:"Approved build plan"}),(0,a.jsx)("ol",{className:"mt-10 border-t border-border/70",children:j.map((e,r)=>(0,a.jsxs)("li",{className:"grid gap-3 border-b border-border/70 py-5 sm:grid-cols-[3rem_minmax(0,1fr)] sm:items-start sm:gap-5",children:[(0,a.jsx)("span",{className:"font-mono text-sm font-medium tabular-nums text-primary",children:String(r+1).padStart(2,"0")}),(0,a.jsx)("p",{className:"text-base leading-7 text-foreground/80",children:e})]},e))})]}),"Preview"===e&&(0,a.jsxs)("div",{className:"min-w-0",children:[(0,a.jsxs)("div",{className:"grid gap-4 border-b border-border/70 bg-muted/30 px-4 py-4 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center sm:px-5",children:[(0,a.jsxs)("div",{children:[(0,a.jsx)("h2",{className:"text-sm font-semibold",children:"Interactive preview"}),(0,a.jsx)("p",{className:"mt-1 text-xs leading-5 text-muted-foreground",children:"Drag a task, start the focus timer, or refresh the live data."})]}),(0,a.jsxs)("div",{className:"flex flex-wrap items-center gap-x-4 gap-y-2 text-xs",children:[(0,a.jsxs)("span",{className:"inline-flex items-center gap-2 whitespace-nowrap font-medium text-emerald-600 dark:text-emerald-400",children:[(0,a.jsx)("span",{className:"size-2 rounded-full bg-emerald-500"}),"Running locally"]}),(0,a.jsx)("span",{className:"whitespace-nowrap text-muted-foreground",children:"Open-Meteo · Frankfurter"})]})]}),(0,a.jsx)("div",{className:"h-[72svh] max-h-[820px] min-h-[620px] bg-slate-100",children:(0,a.jsx)(R,{files:S.map(e=>({path:e.path,content:e.code}))})})]}),"Files"===e&&(0,a.jsxs)("div",{className:"grid min-h-[680px] min-w-0 lg:grid-cols-[18rem_minmax(0,1fr)]",children:[(0,a.jsxs)("aside",{className:"min-w-0 bg-muted/30",children:[(0,a.jsxs)("div",{className:"flex min-h-14 items-center justify-between gap-3 bg-muted/40 px-4",children:[(0,a.jsxs)("div",{className:"min-w-0",children:[(0,a.jsx)("p",{className:"text-sm font-semibold",children:"Project source"}),(0,a.jsxs)("p",{className:"mt-0.5 text-xs text-muted-foreground",children:[S.length," generated files"]})]}),(0,a.jsxs)("span",{className:"inline-flex min-h-8 items-center gap-1.5 whitespace-nowrap rounded-md bg-primary px-2.5 text-[10px] font-semibold uppercase tracking-[0.08em] text-primary-foreground shadow-sm",children:[(0,a.jsx)(b.LockKeyhole,{className:"size-3","aria-hidden":"true"}),"Read-only"]})]}),(0,a.jsx)("nav",{"aria-label":"Generated files",className:"h-52 py-3 lg:h-[624px]",children:(0,a.jsx)(N.Tree,{elements:T,initialSelectedId:d,initialExpandedItems:["components","data","lib"],className:"h-full",children:T.map(e=>(function e(r,t,o){return"folder"===r.type||r.children?(0,a.jsx)(N.Folder,{value:r.id,element:r.name,isSelect:t.startsWith(`${r.id}/`),className:"min-h-9 px-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary",children:r.children?.map(a=>e(a,t,o))},r.id):(0,a.jsxs)(N.File,{value:r.id,isSelect:t===r.id,handleSelect:o,className:"min-h-9 w-full min-w-0 px-2 text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary",children:[(0,a.jsx)("span",{"aria-hidden":"true",className:"truncate",children:r.name}),(0,a.jsx)("span",{className:"sr-only",children:r.id})]},r.id)})(e,_.path,h))})})]}),(0,a.jsxs)("section",{"aria-label":`${_.path} source`,className:"min-w-0 bg-slate-950 text-slate-200",children:[(0,a.jsxs)("div",{className:"flex min-h-14 items-center justify-between gap-4 bg-slate-900/80 px-4 sm:px-5",children:[(0,a.jsxs)("div",{className:"flex min-w-0 items-center gap-2.5",children:[(0,a.jsx)(m.Code2,{className:"size-4 shrink-0 text-blue-400"}),(0,a.jsx)("span",{className:"truncate font-mono text-xs text-slate-200 sm:text-sm",children:_.path})]}),(0,a.jsxs)("div",{className:"flex shrink-0 items-center gap-3 text-[10px] uppercase tracking-wider text-slate-500",children:[(0,a.jsx)("span",{children:_.language}),(0,a.jsxs)("span",{className:"hidden sm:inline",children:[_.code.split("\n").length," lines"]})]})]}),(0,a.jsx)("pre",{className:"max-h-[720px] min-h-[520px] overflow-auto py-4 text-xs leading-6 sm:py-5 sm:text-[13px]",children:(0,a.jsx)("code",{className:"block min-w-max",children:_.code.split("\n").map((e,r)=>(0,a.jsxs)("span",{className:"grid grid-cols-[3.25rem_minmax(0,1fr)] px-4 hover:bg-slate-900/70 sm:grid-cols-[4rem_minmax(0,1fr)] sm:px-5",children:[(0,a.jsx)("span",{"aria-hidden":"true",className:"select-none pr-3 text-right font-mono text-slate-600",children:r+1}),(0,a.jsx)("span",{className:"pl-4 font-mono text-slate-300",children:e||" "})]},`${_.path}-${r}`))})})]})]}),"Quality"===e&&(0,a.jsxs)("div",{className:"grid min-h-[680px] lg:grid-cols-[minmax(0,1.08fr)_minmax(18rem,0.92fr)]",children:[(0,a.jsxs)("div",{className:"flex flex-col justify-between border-b border-border/70 px-5 py-10 sm:px-10 sm:py-14 lg:border-b-0 lg:border-r lg:px-12",children:[(0,a.jsxs)("div",{children:[(0,a.jsx)("span",{className:"grid size-12 place-items-center rounded-xl bg-emerald-500/10 text-emerald-600 dark:text-emerald-400",children:(0,a.jsx)(k.ShieldCheck,{className:"size-6"})}),(0,a.jsx)("h2",{className:"mt-8 text-3xl font-semibold tracking-[-0.035em] sm:text-4xl",children:"Quality report"}),(0,a.jsx)("p",{className:"mt-5 max-w-xl text-base leading-7 text-muted-foreground",children:"The export records what was checked, what remains advisory, and how the connected public APIs are expected to behave."})]}),(0,a.jsxs)("div",{className:"mt-10 border-l-2 border-emerald-500 pl-5",children:[(0,a.jsx)("p",{className:"font-semibold text-foreground",children:"Static checks passed"}),(0,a.jsx)("p",{className:"mt-2 text-sm leading-6 text-muted-foreground",children:"The download includes provider notes, resilient fallbacks, source, package scripts, a README, the quality report, and deployment configuration."})]})]}),(0,a.jsxs)("div",{className:"px-5 py-8 sm:px-8 sm:py-10",children:[(0,a.jsx)("h3",{className:"text-sm font-semibold",children:"Recorded results"}),(0,a.jsxs)("div",{className:"mt-5 border-t border-border/70",children:[(0,a.jsx)(A,{label:"Files generated",value:x.qualityReport.filesGenerated}),(0,a.jsx)(A,{label:"Imports resolved",value:x.qualityReport.importsResolved}),(0,a.jsx)(A,{label:"Warnings",value:E}),(0,a.jsx)(A,{label:"API policy notes",value:P})]}),(0,a.jsxs)(w.Button,{variant:"outline",onClick:I,className:"mt-8 min-h-11 w-full whitespace-nowrap",children:[(0,a.jsx)(p.Download,{className:"size-4"})," Download verified source"]})]})]})]})]}),(0,a.jsxs)(o.default,{href:"/?starter=kanban-board",className:"mt-6 inline-flex min-h-11 items-center gap-2 whitespace-nowrap text-sm font-medium text-primary underline decoration-primary/30 underline-offset-4 lg:hidden",children:["Build from this example",(0,a.jsx)(i.ArrowRight,{className:"size-4"})]})]}),(0,a.jsx)("footer",{className:"border-t border-border/70",children:(0,a.jsxs)("div",{className:"mx-auto flex max-w-7xl flex-col gap-3 px-4 py-6 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between sm:px-6",children:[(0,a.jsx)("p",{children:"Waypoint is a public Squid Agent build—not a product mockup."}),(0,a.jsxs)("p",{className:"flex flex-wrap gap-x-3 gap-y-2",children:[(0,a.jsx)("span",{children:"Open-Meteo"}),(0,a.jsx)("span",{"aria-hidden":"true",children:"·"}),(0,a.jsx)("span",{children:"Frankfurter v2"}),(0,a.jsx)("span",{"aria-hidden":"true",children:"·"}),(0,a.jsx)(o.default,{className:"whitespace-nowrap text-foreground underline decoration-border underline-offset-4 hover:decoration-primary",href:"/?starter=kanban-board",children:"Remix this build"})]})]})})]})}],459191)}]);