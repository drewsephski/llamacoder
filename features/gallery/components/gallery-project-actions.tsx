    ...
    <>
      <div className="flex items-center gap-1.5">
        <Button
          ...
          className="h-8 border-b-0 px-2.5 text-muted-foreground transition-colors hover:translate-y-0 hover:border-b-0 hover:bg-accent hover:text-accent-foreground active:translate-y-0 active:border-b-0"
        >
        ...
        <Button
          ...
          className="size-8 border-b-0 text-muted-foreground transition-colors hover:translate-y-0 hover:border-b-0 hover:bg-red-500/15 hover:text-red-400 active:translate-y-0 active:border-b-0"
        >
