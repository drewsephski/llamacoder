    ...
    >
      {Array.from({ length: total }).map((_, i) => (
        ...
        >
          <div
            className={cn(
              "qf-progress-fill absolute inset-0 origin-left rounded-full",
  ...
  return (
    <div
      className={cn(
        ...
        isSelected && [
          ...
          "motion-safe:duration-300 motion-safe:ease-out motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-75",
        ],
    ...
    >
      {mode === "multi" && isSelected && (
        <Check
          className="size-3 motion-safe:delay-75 motion-safe:duration-200 motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-75 motion-safe:fill-mode-both"
          strokeWidth={3}
        />
      )}
      {mode === "single" && isSelected && (
        <span className="size-2 rounded-full bg-current motion-safe:duration-300 motion-safe:ease-out motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-75" />
      )}
    </div>
  );
}
...
function OptionItem({
  ...
  return (
    ...
    >
      <span
        className={cn(
          "qf-option-hover absolute inset-0 -mx-3 -my-0.5 rounded-xl",
        )}
      />
  ...
  return (
    <div
      className={cn(
        ...
        "text-foreground",
        "motion-safe:blur-in-sm motion-safe:duration-300 motion-safe:ease-out motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-95 motion-safe:fill-mode-both",
        className,
      )}
    ...
    >
      <div
        className={cn(
          "qf-surface-receipt relative flex w-full flex-col gap-3 rounded-2xl border border-border/70 px-5 py-4",
        )}
      >
        <div className="flex items-center justify-between gap-3">
          <span className="text-base font-medium tracking-[-0.01em]">{choice.title}</span>
        ...
        <div className="flex flex-col">
          {choice.summary.map((item, index) => (
            <Fragment key={index}>
              ...
              <div
                className="motion-safe:blur-in-sm flex flex-col gap-0.5 text-sm motion-safe:duration-300 motion-safe:ease-out motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-1 motion-safe:fill-mode-both"
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isExiting && [
          "absolute inset-0",
          "motion-safe:blur-out-sm motion-safe:duration-250 motion-safe:ease-in-out motion-safe:animate-out motion-safe:fade-out motion-safe:fill-mode-forwards",
          exitClass,
        ],
        !isExiting &&
          isTransitioning && [
            "motion-safe:blur-in-sm motion-safe:duration-250 motion-safe:ease-in-out motion-safe:animate-in motion-safe:fade-in motion-safe:fill-mode-both",
            enterClass,
          ],
      )}
    ...
    >
      <div className="flex flex-col gap-1">
        <h2 id={titleId} className="text-lg font-semibold leading-tight tracking-[-0.01em]">
          {title}
        </h2>
        {description && (
          <p id={descriptionId} className="text-pretty text-sm leading-relaxed text-muted-foreground">
            {description}
          </p>
        )}
      </div>
...
function StepContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "qf-surface relative flex w-full flex-col gap-4 rounded-2xl border border-border/70 p-5",
        )}
      >
        <div className="flex flex-col gap-1">
        ...
        <div className="mt-1 flex items-center justify-between border-t border-border/40 pt-4">
          {showBack ? (
            <Button
              variant="ghost"
              size="default"
