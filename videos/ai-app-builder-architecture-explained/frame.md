...
description: >
  ...
  accent, the three-step gray text ladder, DM Sans (display/numerals/chrome) + DM Sans (body),
...
typography:
  # — reading ramp (DM Sans body + DM Sans chrome) —
  body:    { fontFamily: "DM Sans", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "DM Sans", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "DM Sans", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "DM Sans", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (DM Sans, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "DM Sans", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "DM Sans", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "DM Sans", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "DM Sans", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "DM Sans", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "DM Sans", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "DM Sans", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — already set to **DM Sans** (display) / **Aeonik** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{300, 400, 500, 600, 700, 800, 900}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
